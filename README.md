...
- Sends non-Fable requests to equal-priority accounts whose Fable quota is spent (90% by default, `fableSpentThreshold`) first, preserving shared 5h capacity on accounts that can still run Fable.
